    ...
    return (
        <div className="space-y-4">
            <div 
                ...
                className="relative w-full bg-white rounded-2xl border-2 border-dashed border-slate-200 overflow-hidden cursor-crosshair shadow-inner"
                style={{ paddingBottom: '65%' }}
            >
                {/* Background Image - The new model moto */}
                <img 
                    src="/modelo_moto.jpg" 
                    alt="Modelo Moto" 
                ...
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm p-3 rounded-xl border border-slate-200 shadow-sm pointer-events-none z-10">
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Instrucciones</p>
                    <p className="text-xs font-bold text-ises-dark flex items-center gap-2">
                        <span className="w-2 h-2 rounded-full bg-ises-green animate-pulse" />
                        Toca la moto para marcar daño
                    </p>
                </div>
                ...
                {pins.map(pin => (
                    ...
                    >
                        ...
                        {/* Remove indicator on hover could be added here */}
                    </button>
                ))}
                            ...
                            <div key={pin.id} className="flex items-center justify-between bg-white p-3 rounded-xl border border-slate-200 shadow-sm animate-in slide-in-from-left-2 transition-all">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-slate-400 font-bold uppercase">Pieza Marcada</p>
                                    </div>
                                </div>
                                <button 
